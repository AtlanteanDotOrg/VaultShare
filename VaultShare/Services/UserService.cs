...
public async Task UpdatePaymentMethodAsync(string userId, PaymentMethodRequest paymentMethod)
{
    ...
    // Update each field within PaymentMethod individually
    var update = Builders<User>.Update
        .Set(u => u.PaymentMethod.CardNumber, paymentMethod.CardNumber)
        .Set(u => u.PaymentMethod.Expiry, paymentMethod.Expiry)
        .Set(u => u.PaymentMethod.Cvc, paymentMethod.Cvv)
        .Set(u => u.PaymentMethod.CardNickname, paymentMethod.Name);
